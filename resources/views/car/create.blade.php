                ...
                <form action="{{ route('car.store') }}" method="POST" enctype="multipart/form-data" class="space-y-6">
                    ...
                    <div>
                        ...
                        <input type="file" id="image" name="image" accept="image/*"
                            class="mt-2 block h-9 w-full text-sm text-gray-800 border border-gray-300 rounded-lg shadow-sm focus:ring-blue-500 focus:border-blue-500 @error('image') is-invalid @enderror">
                        @error('image')
                    ...
                    <div class="flex flex-col lg:flex-row w-full space-y-4 lg:space-y-0 lg:space-x-4">
                        <div class="w-full">
                            ...
                            <input type="text" id="nama" name="nama" value="{{ old('nama') }}"
                                ...
                                class="mt-2 block h-9 w-full text-sm text-gray-800 border border-gray-300 rounded-lg shadow-sm focus:ring-blue-500 focus:border-blue-500 @error('nama') is-invalid @enderror">
                            @error('nama')
                            <p class="text-sm text-red-600 mt-1">{{ $message }}</p>
                            @enderror
                        </div>
                        ...
                        <div class="w-full">
                            ...
                            <input type="number" id="count" name="count" value="{{ old('count') }}"
                                ...
                                class="mt-2 block h-9 w-full text-sm text-gray-800 border border-gray-300 rounded-lg shadow-sm focus:ring-blue-500 focus:border-blue-500 @error('count') is-invalid @enderror">
                            @error('count')
                            <p class="text-sm text-red-600 mt-1">{{ $message }}</p>
                            @enderror
                        </div>
                    ...
                    <div class="flex flex-col lg:flex-row w-full space-y-4 lg:space-y-0 lg:space-x-4">
                        <div class="w-full">
                            ...
                            <select id="jenis" name="jenis"
                                class="mt-2 block h-9 w-full text-sm text-gray-800 border border-gray-300 rounded-lg shadow-sm focus:ring-blue-500 focus:border-blue-500 @error('jenis') is-invalid @enderror">
                        ...
                        <div class="w-full">
                            ...
                            <select id="merek" name="merek"
                                class="mt-2 block h-9 w-full text-sm text-gray-800 border border-gray-300 rounded-lg shadow-sm focus:ring-blue-500 focus:border-blue-500 @error('merek') is-invalid @enderror">
                    ...
                    <div class="flex flex-col lg:flex-row w-full space-y-4 lg:space-y-0 lg:space-x-4">
                        <div class="w-full">
                            ...
                            <input type="text" id="tipe" name="tipe" value="{{ old('tipe') }}"
                                ...
                                class="mt-2 block h-9 w-full text-sm text-gray-800 border border-gray-300 rounded-lg shadow-sm focus:ring-blue-500 focus:border-blue-500 @error('tipe') is-invalid @enderror">
                            @error('tipe')
                            <p class="text-sm text-red-600 mt-1">{{ $message }}</p>
                            @enderror
                        </div>
                        ...
                        <div class="w-full">
                            ...
                            <input type="text" id="plat_nomor" name="plat_nomor" value="{{ old('plat_nomor') }}"
                                ...
                                class="mt-2 block h-9 w-full text-sm text-gray-800 border border-gray-300 rounded-lg shadow-sm focus:ring-blue-500 focus:border-blue-500 @error('plat_nomor') is-invalid @enderror">
                            @error('plat_nomor')
                            <p class="text-sm text-red-600 mt-1">{{ $message }}</p>
                            @enderror
                        </div>
                    ...
                    <div class="flex flex-col lg:flex-row w-full space-y-4 lg:space-y-0 lg:space-x-4">
                        <div class="w-full">
                            ...
                            <input type="number" id="rental_price" name="rental_price" value="{{ old('rental_price') }}"
                                ...
                                class="mt-2 block h-9 w-full text-sm text-gray-800 border border-gray-300 rounded-lg shadow-sm focus:ring-blue-500 focus:border-blue-500 @error('rental_price') is-invalid @enderror">
                            @error('rental_price')
                            <p class="text-sm text-red-600 mt-1">{{ $message }}</p>
                            @enderror
                        </div>
                        ...
                        <div class="w-full">
                            ...
                            <input type="number" id="tahun_produksi" name="tahun_produksi" value="{{ old('tahun_produksi') }}"
                                ...
                                class="mt-2 block h-9 w-full text-sm text-gray-800 border border-gray-300 rounded-lg shadow-sm focus:ring-blue-500 focus:border-blue-500 @error('tahun_produksi') is-invalid @enderror">
                    ...
                    <div>
                        ...
                        <textarea id="note" name="note" rows="3"
                            class="mt-2 block w-full text-sm text-gray-800 border border-gray-300 rounded-lg shadow-sm focus:ring-blue-500 focus:border-blue-500 @error('note') is-invalid @enderror"
                    ...
                    <div class="flex justify-between">
                        ...
                        <button type="reset"
                            class="bg-gray-300 text-gray-800 font-semibold py-2 px-4 rounded-lg shadow hover:bg-gray-400">
                            Reset
                        </button>
                    </div>
                </form>
